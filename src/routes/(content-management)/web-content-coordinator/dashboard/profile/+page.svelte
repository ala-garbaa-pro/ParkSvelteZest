			...
			<nav class="flex-none px-4 sm:px-6 lg:px-0">
				<ul role="list" class="flex gap-x-3 gap-y-1 whitespace-nowrap lg:flex-col">
					<li>
						...
						<a
							href="#"
							class="flex py-2 pl-2 pr-3 text-sm font-semibold leading-6 text-indigo-600 rounded-md bg-gray-50 group gap-x-3"
						>
							<svg
								class="w-6 h-6 text-indigo-600 shrink-0"
								fill="none"
								viewBox="0 0 24 24"
								stroke-width="1.5"
								stroke="currentColor"
					...
					<li>
						<a
							href="#"
							class="flex py-2 pl-2 pr-3 text-sm font-semibold leading-6 text-gray-700 rounded-md hover:text-indigo-600 hover:bg-gray-50 group gap-x-3"
						>
							<svg
		...
		<main class="px-4 py-16 sm:px-6 lg:flex-auto lg:px-0 lg:py-20">
			<div class="max-w-2xl mx-auto space-y-16 sm:space-y-20 lg:mx-0 lg:max-w-none">
				<div>
					...
					<dl
						class="mt-6 space-y-6 text-sm leading-6 border-t border-gray-200 divide-y divide-gray-100"
					>
				...
				<div>
					...
					>
						...
						<div class="flex pt-6">
							<dt class="flex-none w-64 pr-6 font-medium text-gray-900" id="timezone-option-label">
								Automatic timezone
							</dt>
							<dd class="flex items-center justify-end flex-auto">
								...
								<button
									type="button"
									class="flex w-8 p-px transition-colors duration-200 ease-in-out bg-gray-200 rounded-full cursor-pointer ring-1 ring-inset ring-gray-900/5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
									role="switch"
									aria-checked="true"
